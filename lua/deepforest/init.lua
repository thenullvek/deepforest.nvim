...
--
--  Name: deepforest.nvim
--  License: MIT
--  Maintainer: Duncan Marsh (slugbyte@slugbyte.com)
--  Repository: https://github.com/slugbyte/deepforest.nvim

local dev = require("deepforest.dev")
local color = require("deepforest.color")
local color_special = require("deepforest.color-special")
local create_theme = require("deepforest.create-theme")
local tweak = require("deepforest.tweak")
local highlight = require("deepforest.highlight")
...
---@class DeepForestConfigTweakSyntax
---@field string ?string
...
---@class DeepForestConfigTweakBackground
---@field normal ?string
---@field menu ?string
---@field popup ?string
---@field telescope ?string

---@class DeepForestConfigDisablePlugin
...
---@field tweak_ui ?DeepForestConfigTweakUI
---@field tweak_pallet ?DeepForestConfigTweakColor
---@field tweak_syntax ?DeepForestConfigTweakSyntax
---@field tweak_background ?DeepForestConfigTweakBackground
---@field tweak_highlight ?{[string]:vim.api.keyset.highlight}
---@field disable_plugin DeepForestConfigDisablePlugin

--- @type DeepForestConfig | nil
local USER_CONFIG = nil

--- @type DeepForestConfig
...
---configure deepforest with optional settings
---@param config ?DeepForestConfig

...
---@class DeepForestHighlightGroup
---@field plugin_name ?string
---@field dont_skip ?boolean -- force highlights to run if true
---@field highlight DeepForestHighlightSpec[]
    ...
    return {
        {
            ...
            highlight = {
                ...
                spec.co("CursorLineNr", theme.ui.fg_line_num_cur, theme.ui.bg_cursorline),
                ...
                spec.fg("Class", theme.syntax.class),
                ...
                -- DIAGNOSTICS
                spec.fg("DiagnosticOk", theme.diagnostic.ok),
                spec.fg("DiagnosticHint", theme.diagnostic.hint),
                spec.fg("DiagnosticInfo", theme.diagnostic.info),
                spec.fg("DiagnosticWarn", theme.diagnostic.warn),
                spec.fg("DiagnosticError", theme.diagnostic.error),
                spec.fg("DiagnosticDeprecated", theme.diagnostic.deprecated),
                ...
                spec.fg("@attribute", theme.syntax.attribute),
                spec.cf("@type", theme.syntax.type, { bold = true }),
                spec.cf("@type.definition", theme.syntax.type_def, { bold = true }),
                spec.fg("@property", theme.syntax.property),
                spec.fg("@label", theme.syntax.label),
                ...
                spec.fg("@constructor", theme.syntax.ctor_dtor),

                -- treesitter func
                spec.fg("@function", theme.syntax.func_def),
                spec.fg("@function.method", theme.syntax.func_method),
                spec.fg("@function.call", theme.syntax.func_call),
                spec.fg("@function.method.call", theme.syntax.func_method),
                spec.cf("@variable.parameter", theme.syntax.func_param, { italic = true }),
                ...
                -- treesitter builtin
                spec.cf("@type.builtin", theme.syntax.type_primitive, { bold = true }),
                spec.fg("@tag.builtin", theme.syntax.tag),
                spec.fg("@variable.builtin", theme.syntax.var_builtin),
                spec.fg("@function.builtin", theme.syntax.func_builtin),
                spec.fg("@module.builtin", theme.syntax.builtin),
                spec.cf("@constant.builtin", theme.syntax.const_builtin, { italic = true }),
        ...
        require("deepforest.plugin.cmp")(theme),
        require("deepforest.plugin.flash")(theme),
        require("deepforest.plugin.git-gutter")(theme),
        require("deepforest.plugin.git-signs")(theme),
        require("deepforest.plugin.lazy")(theme),
        require("deepforest.plugin.lightbulb")(theme),
        require("deepforest.plugin.lsp-config")(theme),
        require("deepforest.plugin.mason")(theme),
        require("deepforest.plugin.oil")(theme),
        require("deepforest.plugin.rainbow-delimiter")(theme),
        require("deepforest.plugin.telescope")(theme),
        require("deepforest.plugin.todo-comments")(theme),
        require("deepforest.plugin.tree")(theme),
        require("deepforest.plugin.trouble")(theme),
        require("deepforest.plugin.which-key")(theme),
        require("deepforest.plugin.notify")(theme),
        require("deepforest.plugin.navic")(theme),
        require("deepforest.plugin.yanky")(theme),
        require("deepforest.plugin.headlines")(theme),
        require("deepforest.plugin.noice")(theme),
